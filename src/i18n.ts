...
export const ui = {
  en: {
    ...
    readingQueueDesc:
      'Saved articles to read later and Next Research topics from your notes — your study backlog.',
    savedArticles: 'Saved articles',
    savedOn: 'Saved',
    noReadingQueue: 'Nothing saved yet.',
    noBacklog: 'Nothing in your backlog yet.',
    backToNotes: '← All notes',
    studyGrass: 'Study Grass',
    studyGrassDesc:
      'Writing activity for this blog. Each filled cell marks a day with notes — separate from your GitHub profile.',
    totalNotes: 'Notes',
    ...
    taggedNotes: 'Notes',
    taggedReadingQueue: 'Saved articles',
  ...
  ko: {
    ...
    readingQueueDesc:
      '나중에 읽으려고 킵해 둔 글과 노트에 적어 둔 Next Research 주제 — 공부 백로그입니다.',
    savedArticles: '읽어둘 글',
    savedOn: '저장',
    noReadingQueue: '아직 킵해 둔 글이 없습니다.',
    noBacklog: '아직 백로그가 비어 있습니다.',
    backToNotes: '← 모든 노트',
    studyGrass: 'Study Grass',
    studyGrassDesc:
      '이 블로그에 작성한 노트 기록입니다. GitHub 계정 잔디와는 별개로, 노트를 남긴 날만 칸이 채워집니다.',
    totalNotes: '총 노트',
    activeDays: '기록한 날',
    ...
    scrollToTop: '↑ 상단으로',
    taggedWith: (tag: string) => `#${tag}`,
    tagPageDesc: (tag: string) => `“${tag}” 태그가 붙은 노트와 읽어둘 글.`,
    taggedNotes: '노트',
    taggedReadingQueue: '읽어둘 글',
